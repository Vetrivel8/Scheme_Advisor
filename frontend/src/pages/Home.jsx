            ...
            <div className="relative">
              ...
              <div className="relative z-10 p-4">
                ...
                <div className="absolute -bottom-8 -left-8 bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-xl flex items-center gap-4 border border-primary/5 animate-bounce-slow">
                  ...
                  <div>
                    <p className="text-xs font-bold text-primary uppercase tracking-widest leading-none mb-1">Dignity Guaranteed</p>
                    <p className="text-sm font-medium text-on-surface-variant">Verified Schemes Only</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-on-surface-variant leading-relaxed">
                Refine your paths by category. From sustainable farming to technical education,
                we've mapped the support systems available to you.
              </p>
            </div>
      ...
      <section className="py-20 border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <p className="text-sm font-bold tracking-[0.3em] uppercase text-on-surface/40">
            Dignity Through Design • © 2026 Smart Scheme Advisor
          </p>
        </div>
      </section>
    </div>
